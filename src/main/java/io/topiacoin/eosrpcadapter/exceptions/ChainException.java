...
public class ChainException extends EOSException {
    /**
     * Constructs a new exception with {@code null} as its detail message. The cause is not initialized, and may
     * subsequently be initialized by a call to {@link #initCause}.
     */
    public ChainException(ErrorResponse details) {
        super(details);
    }
     ...
     *                method.
     */
    public ChainException(String message, ErrorResponse details) {
     ...
     * @since 1.4
     */
    public ChainException(String message, Throwable cause, ErrorResponse details) {
     ...
     * @since 1.4
     */
    public ChainException(Throwable cause, ErrorResponse details) {
        super(cause, details);
    }
}
